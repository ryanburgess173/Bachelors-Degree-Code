...
class PartTest {
    ...
    @Test
    void testInventoryMaximum() {
    	Part part1 = new InhousePart();
    	part1.setId(1);
    	part1.setName("Nikon F2 Backdoor");
    	part1.setPrice(70.00);
    	part1.setInvMin(2);
    	part1.setInvMax(5);
    	part1.setInv(6);
    	Assertions.assertNotEquals(part1.getInv(), 6);
    }
    
    @Test
    void testInventoryMinimum() {
    	Part part1 = new InhousePart();
    	part1.setId(1);
    	part1.setName("Nikon F2 Backdoor");
    	part1.setPrice(70.00);
    	...
    	part1.setInvMax(5);
    	part1.setInv(1);
    	Assertions.assertNotEquals(part1.getInv(), 1);
    }
}